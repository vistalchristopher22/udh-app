      ...
      <div class="col-lg-8">
        <div class="row">
          <div class="card rounded-0  border-right-0">
            ...
            <div class="text-center p-3" v-if="details.employee_id == null">
            ...
            <div class="card-body" v-else>
              <div class="form-group row">
                ...
                <div class="col-lg-10">
                  <input class="form-control" type="text" disabled v-model="details.employee_id">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-10">
                  <input class="form-control" type="text" v-model="details.first_name">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-10">
                  <input class="form-control" type="text" v-model="details.middle_name">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-10">
                  <input class="form-control" type="text" v-model="details.last_name">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-10">
                  <input class="form-control" v-model="details.suffix" type="text">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-10">
                  <input class="form-control" v-model="details.phone_number" type="text">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-10">
                  <textarea class="form-control" v-model="details.address" type="text"></textarea>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-10">
                  <input class="form-control" v-model="details.active_status" type="text">
                </div>
              </div>
            ...
            <div class="card-footer text-end">
              <button class="btn btn-soft-success" @click="updatePersonalInformation">Update</button>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card rounded-0 ">
            ...
            <div class="card-body" v-else>
              <div class="form-group row">
                ...
                <div class="col-lg-9">
                  <input class="form-control" v-model="details.email" readonly type="text">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9">
                  <input class="form-control" v-model="details.password" type="password">
                </div>
              </div>
            </div>
          ...
          <div class="card rounded-0 ">
            ...
            <div class="card-body" v-else>
              <div class="form-group row">
                ...
                <div class="col-lg-9">
                  <select class="form-select" @change="changePosition(this)" disabled v-model="details.position">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9">
                  <input class="form-control" readonly :value="details?.position_detail?.description" type="text">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9">
                  <select class="form-select" disabled v-model="details.office">
                    <option value="" selected disabled></option>
                    <option :value="office.id" v-for="office in offices" :key="office.id">
                      {{ office.name }}
                    </option>
                  </select>
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-4">
                  <div class="col-lg-9">
                    <input class="form-control" readonly :value="details?.position_detail?.salary_grade" type="text">
                  </div>
                </div>

                <div class="col-lg-5">
                  <div class="col-lg-9">
                    <input class="form-control" readonly :value="details?.position_detail?.step" type="text">
                  </div>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9">
                  <select v-model="details.work_status" disabled name="" id="" class="form-select">
