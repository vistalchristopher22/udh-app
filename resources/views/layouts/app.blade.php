    ...
    <div class="left-sidenav">
        ...
        <div class="menu-content h-100" data-simplebar>
            <ul class="metismenu left-sidenav-menu">
                ...
                {{--                                                  class="align-self-center menu-icon"></i><span>Forms</span><span --}}
                ...
                @role('administrator')
                    ...
                    <li>
                        <a href="{{ route('roles.index') }}"> <i data-feather="lock"
                                class="align-self-center menu-icon"></i><span>Roles & Permissions</span>
                        </a>
                    </li>
                @endrole
