        ...
        <div class="accordion-item">
            <h5 class="accordion-header m-0" id="headingOne">
                <button class="accordion-button fw-semibold collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <span class="h5 fw-medium">What are you looking for?</span>
                </button>
            </h5>
            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                ...
                <div class="accordion-body">
                    ...
                    <div class="text-end">
                        <input type="submit" class="btn btn-primary mb-2" id="btnSubmitFilter" value="Apply">
                    </div>
    ...
    <div class="card">
        <div class="card-header bg-dark d-flex justify-content-between align-items-center">
            <div class="card-title text-white">
                Complete listing <span class="text-lowercase">of</span> Forms
            </div>
            <div>
                <a href="{{ route('document.create') }}" class="btn btn-light fw-medium">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <p class="mb-0 fw-semibold mt-2">{{ $document?->office_responsible_detail?->name }}
                                        </p>
                                    </div>
                                    <div>
                                        <div class="d-flex justify-content-between">
                                            <h6 class="fw-semibold">Access Level : <span
                                                    @class([
                                                        'badge',
                                                        'text-capitalize',
                                                        'bg-info' => $document->access_level === 'private',
                                                        'bg-primary' => $document->access_level === 'public',
                                                        'bg-danger' => $document->access_level === 'restricted',
