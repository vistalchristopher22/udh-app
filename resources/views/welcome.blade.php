...
<!-- Mirrored from themesbrand.com/qexal/layout/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Oct 2023 09:37:54 GMT -->
...
<body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-offset="20" class="home-4">
    ...
    <!--Navbar Start-->
    <nav class="navbar navbar-expand-lg navbar-light navbar-custom fixed-top bg-white" id="navbar">
        <div class="container">
            <!-- LOGO -->
    ...
    <!-- Hero Start -->
    <section class="hero-4 position-relative bg-light" style="background-image: url(/landing/images/hero-4-bg.jpg);"
        id="home">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    ...
                    <h1 class="font-weight-semibold mb-4 hero-4-title">We Help Startups Launch Their Products</h1>
                    <p class="mb-5 text-muted">Nemo enim ipsam voluptatem quia voluptas sit aut aspernatur aut fugit sed
                        quia consequuntur magni dolores ratione voluptatem nesciunt.</p>
                    <a href="#" class="btn btn-lg btn-primary me-2">Get Started</a>
                    <a href="#" class="btn btn-lg btn-soft-primary me-2">Try for free</a>
                </div>
                <!-- end col -->
                <div class="col-lg-4 ms-lg-auto text-center mt-lg-0 mt-5">
                    <div class="d-inline-block" data-bs-toggle="modal" data-bs-target="#watchvideomodal">
                        <a href="javascript: void(0);" class="play-icon-circle video-play-icon">
                            <i class="icon pl-1" data-feather="play"></i>
                        </a>
                    </div>
                ...
                <div class="col-md-6 ms-md-auto order-1 order-md-2">
                    <div class="position-relative">
                        <div class="ms-5 features-img">
                            <img src="/landing/images/features-1.jpg" alt=""
                                class="img-fluid d-block mx-auto rounded shadow" />
                        </div>
                        <img src="/landing/images/dot-img.png" alt="" class="dot-img-left" />
                    </div>
                </div>
                <!-- end col -->
            </div>
                ...
                <div class="col-md-6">
                    <div class="position-relative mb-md-0 mb-5">
                        <div class="me-5 features-img">
                            <img src="/landing/images/features-2.jpg" alt=""
                                class="img-fluid d-block mx-auto rounded shadow" />
                        </div>
                        <img src="/landing/images/dot-img.png" alt="" class="dot-img-right" />
                    </div>
                </div>
                <!-- end col -->
                                ...
                                <div class="col-lg-4">
                                    <div
                                        ...
                                        <div class="card-body px-4 py-5">
                                            ...
                                            <a href="javascript: void(0);" class="btn btn-soft-primary">Sign In</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- end col -->
                        ...
                        <div class="position-relative overflow-hidden">
                            ...
                            <ul class="list-inline p-3 mb-0 team-social-item">
                                <li class="list-inline-item mx-3">
                                    <a href="javascript: void(0);" class="team-social-icon h-primary"><i
                                            class="icon-sm" data-feather="facebook"></i></a>
                                </li>
                                <li class="list-inline-item mx-3">
                                ...
                                <li class="list-inline-item mx-3">
                                    <a href="javascript: void(0);" class="team-social-icon h-danger"><i
                                            class="icon-sm" data-feather="instagram"></i></a>
                                </li>
                            </ul>
                        </div>
                        <div class="p-4">
...
<!-- Mirrored from themesbrand.com/qexal/layout/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Oct 2023 09:38:02 GMT -->
